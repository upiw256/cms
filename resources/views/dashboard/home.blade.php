  ...
  <div class="flex h-screen">
    <div class="flex-row h-screen w-3/12 bg-white drop-shadow-lg">
      ...
      <a href="{{route('admin.post')}}">
        <div class="ml-2 mr-2 rounded p-4 hover:bg-blue-400 hover:cursor-pointer flex items-center hover:text-white font-semibold {{($active === 'post') ? 'bg-blue-400 text-white' : ''}}"><i class="fa-regular fa-pen-to-square"></i>
          <div class="flex justify-between w-full ml-3">
