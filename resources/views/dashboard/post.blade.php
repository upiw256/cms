...
<div class="p-3">
    ...
    <div class="bg-white rounded shadow-inherit p-3">
        <div class="font-sans">
            <button class="bg-blue-400 p-3 rounded-lg text-white hover:bg-blue-300"><i class="fa-regular fa-square-plus"></i> Postingan</button>
