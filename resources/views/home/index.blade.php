    ...
    <nav class="p-5 w-full bg-blue-400 text-white justify-start items-center shadow md:flex md:items-center md:justify-between">
        <div class="flex justify-between items-center">
            ...
            <div class="md:hidden block">
                <span id="menu" name="menu" class="text-3xl cursor-pointer material-icons mx-2" >
                    menu
                </span>
            </div>
        </div>
        <ul class="md:flex md:items-center z-[-1] md:z-auto md:static absolute bg-blue-400 w-full left-0 md:w-auto md:py-0 py-4 md:pl-0 pl-7 md:opacity-100 opacity-0 top-[-400px] transition-all ease-in-out duration-500">
        ...
        <div class="relative">
            <ul id="slider">
                <li class="h-[50vh] relative">
                    <img class="h-full object-cover w-full" src="https://picsum.photos/600/600" alt="image">
